...
func NewGinServer(db database.Database, conf config.Config, log logger.Logger, validator validator.Validator) Server {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:3000", "https://julong-mpp.avolut.com", "https://julong-recruitment.avolut.com", "https://julong-onboarding.avolut.com"}, // Frontend URL
